...
\todo[inline]{@FIXME ba'jales la altura al pdf generado de las figuras~\ref{fig:r-voting}~y~\ref{fig:voting-cycle}}
...
\todo[inline]{@TODO deja claro a la hora d definir el problema d q cada participante puede ser a la vez votante y candidato para poder hablar indistintamente en ese senti2}
