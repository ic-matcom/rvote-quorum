...
\title{Sistema de Votaci\'on Representativa sobre GoQuorum}
\author{\\\vspace{0.25cm}Andy Ledesma Garc\'ia}
\advisor{\\\vspace{0.25cm}Yaidir Mustelier Ruiz}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{@TODO Fecha\\\vspace{0.25cm}\href{https://github.com/ic-matcom/rvote-quorum}{https://github.com/ic-matcom/rvote-quorum}}
